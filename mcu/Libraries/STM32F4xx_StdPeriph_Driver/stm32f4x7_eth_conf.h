...
#define USE_ENHANCED_DMA_DESCRIPTORS
    ...
    /* #define USE_Delay */ /* 使用内置的 ETH_Delay 函数 */
...
/* ETH_Delay 函数声明 (定义在 stm32f4x7_eth.c 中) */
void ETH_Delay(__IO uint32_t nCount);
#endif

/* Use application-defined Ethernet driver buffers */
...
/* These values depend on the external PHY.
   The project targets LAN8720/LAN8742A-style PHY status register layout. */
