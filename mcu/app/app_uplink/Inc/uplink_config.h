 ...
 *
 * @note 用法：
 * - 定义一个 uplink_config_t cfg
 * - 调用 uplink_config_set_defaults(&cfg) 生成默认值
 * - 根据环境修改 cfg.endpoint.host / cfg.endpoint.port / cfg.endpoint.path
 * - 调用 uplink_init(&uplink, &cfg, &platform)
 *
