...
void I2C_ResetChip(void)
{
	  ...
	  /* 关键：明确驱动 INT 引脚为低电平，确保 I2C 地址为 0xBA */
...
static void i2c_Delay(void)
{
	 ...
	 * I2C总线位延迟。
	 *
	 * 注意：必须使用 volatile + NOP，避免在 -O2/-O3 下被编译器优化掉，
	 * 否则会导致 I2C 时序失真（常见表现：设备无应答/随机 NACK）。
	 */
